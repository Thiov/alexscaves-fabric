...
public class GumbeeperEntity extends Monster implements PowerableMob, PossessedByLicowitch {
    ...
    public static boolean checkGumbeeperSpawnRules(EntityType<? extends Monster> entityType, ServerLevelAccessor levelAccessor, EntitySpawnReason mobSpawnType, BlockPos blockPos, RandomSource randomSource) {
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compoundTag) {
        ...
        this.setGumballsLeft(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compoundTag, "Gumballs"));
    }
    ...
    protected void dropCustomDeathLoot(ServerLevel level, DamageSource damageSource, boolean recentlyHit) {
        ...
        if (damageSource.getEntity() instanceof CaniacEntity) {
            com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, ACItemRegistry.MUSIC_DISC_TASTY_FRAGMENT.get());
        }
    }
