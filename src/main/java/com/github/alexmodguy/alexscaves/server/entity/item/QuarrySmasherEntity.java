            ...
            if (damageSustained >= 10) {
                ...
                if (!this.isRemoved()) {
                    for (int i = 0; i < 1 + random.nextInt(1); i++) {
                        com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, ACItemRegistry.AZURE_NEODYMIUM_INGOT.get());
                    }
                    for (int i = 0; i < 1 + random.nextInt(1); i++) {
                        com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, ACItemRegistry.SCARLET_NEODYMIUM_INGOT.get());
                    }
                }
