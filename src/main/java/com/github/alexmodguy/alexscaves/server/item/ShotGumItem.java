...
public class ShotGumItem extends Item implements UpdatesStackTags, AlwaysCombinableOnAnvil {
    ...
    public static float getLerpedShootTime(ItemStack stack, float f) {
        ...
        float prev = (float) com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compoundtag, "PrevShootTime");
        float current = (float) com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compoundtag, "ShootTime");
        return prev + f * (current - prev);
    }

    public static float getLerpedCrankAngle(ItemStack stack, float f) {
        CompoundTag compoundtag = stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag();
        float prev = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(compoundtag, "PrevCrankAngle");
        float current = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(compoundtag, "CrankAngle");
        return prev + f * (current - prev);
    }

    public static int getShootTime(ItemStack stack) {
        CompoundTag compoundtag = stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag();
        return com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compoundtag, "ShootTime");
    }
    ...
    public static float getCrankAngle(ItemStack stack) {
        CompoundTag compoundtag = stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag();
        return com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(compoundtag, "CrankAngle");
    }
    ...
    public static int getGumballsLeft(ItemStack stack) {
        CompoundTag compoundtag = stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag();
        return compoundtag.contains("Gumballs") ? com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compoundtag, "Gumballs") : MAX_AMMO;
    }
    ...
    public static boolean isShooting(ItemStack stack) {
        CompoundTag compoundtag = stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag();
        return com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compoundtag, "Shooting");
    }
    ...
    public void inventoryTick(ItemStack stack, net.minecraft.server.level.ServerLevel level, Entity entity, net.minecraft.world.entity.EquipmentSlot equipmentSlot) {
        ...
        if (com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(tag, "PrevShootTime") != com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(tag, "ShootTime")) {
            tag.putInt("PrevShootTime", getShootTime(stack));
            tagModified = true;
        }
        if (com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(tag, "PrevCrankAngle") != com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(tag, "CrankAngle")) {
