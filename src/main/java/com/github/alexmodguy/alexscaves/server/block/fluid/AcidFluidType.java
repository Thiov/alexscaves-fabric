...
public class AcidFluidType extends FluidType {
    ...
    public static final Identifier FLUID_STILL = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "block/acid_still");
    public static final Identifier FLUID_FLOWING = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "block/acid_flowing");
    public static final Identifier OVERLAY = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/misc/under_acid.png");
