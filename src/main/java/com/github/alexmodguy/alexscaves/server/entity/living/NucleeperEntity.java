...
public class NucleeperEntity extends Monster implements ActivatesSirens, PowerableMob {
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compoundTag) {
        ...
        this.setCharged(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compoundTag, "Charged"));
        this.setCloseTime(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compoundTag, "CloseTime"));
    }
    ...
    private void explode() {
        ...
        if(!com.github.alexmodguy.alexscaves.server.entity.util.LevelCompat.getGameRules(level()).get(net.minecraft.world.level.gamerules.GameRules.MOB_GRIEFING)){
    ...
    protected void dropCustomDeathLoot(ServerLevel level, DamageSource damageSource, boolean recentlyHit) {
        ...
        if (damageSource.getEntity() instanceof TremorzillaEntity && damageSource.is(ACDamageTypes.TREMORZILLA_BEAM)) {
            com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, ACItemRegistry.MUSIC_DISC_FUSION_FRAGMENT.get());
        }
    }
