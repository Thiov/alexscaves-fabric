...
public class CandicornEntity extends TamableAnimal implements KeybindUsingMount, IAnimatedEntity, PlayerRideableJumping, Saddleable, RidingMeterMount, PossessedByLicowitch {
    ...
    public static boolean checkCandicornSpawnRules(EntityType<? extends Animal> type, LevelAccessor levelAccessor, EntitySpawnReason mobType, BlockPos pos, RandomSource randomSource) {
    ...
    public void equipSaddle(ItemStack saddle, @Nullable SoundSource soundSource) {
        ...
        if (soundSource != null) {
            this.level().playSound((Player)null, this, SoundEvents.PIG_SADDLE.value(), soundSource, 0.5F, 1.0F);
        }
    }
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        ...
        this.setCommand(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "Command"));
        this.setSaddled(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "Saddled"));
        this.setVariant(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "Variant"));
    }
    ...
    public void calculateEntityAnimation(boolean flying) {
        ...
        float f1 = (float) Mth.length(this.getX() - this.xo, 0.0D, this.getZ() - this.zo);
    ...
    public void tick() {
        ...
        if (!this.isVehicle() && !this.isCharging() && this.getDeltaMovement().horizontalDistanceSqr() > 2.5e-7D) {
            ...
            this.yBodyRot = Mth.approachDegrees(this.yBodyRot, moveYaw, 30.0F);
            this.yBodyRotO = this.yBodyRot;
            this.yHeadRot = Mth.approachDegrees(this.yHeadRot, moveYaw, 30.0F);
        }
        ...
        if(this.isCharging()){
            ...
            for (LivingEntity entity : this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(3.5D))) {
                ...
                if (!(this.isTame() && isAlliedTo(entity)) && !entity.isPassengerOfSameVehicle(this) && !(entity instanceof CandicornEntity) && entity != this && dist < 7.0F) {
                    ...
                    entity.hurtOrSimulate(this.damageSources().mobAttack(this), 7.0F + dmgExtra);
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (!interactionresult.consumesAction() && !type.consumesAction()) {
            if (itemstack.is(Items.SHEARS) && this.isSaddled() && isTame() && isOwnedBy(player)) {
                ...
                com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, Items.SADDLE);
                return InteractionResult.SUCCESS;
                ...
                if (player.isShiftKeyDown()) {
                    ...
                    player.sendOverlayMessage(Component.translatable("entity.alexscaves.all.command_" + this.getCommand(), this.getName()));
    ...
    public boolean causeFallDamage(float f1, float f2, DamageSource damageSource) {
        ...
        if (i > 0) {
            ...
            this.hurtOrSimulate(damageSource, (float)i);
            return true;
        } else {
            return flag;
        }
    ...
    protected void dropEquipment() {
        super.dropEquipment((net.minecraft.server.level.ServerLevel) level());
        if (this.isSaddled()) {
            com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, Items.SADDLE);
        }
    }
    ...
    protected boolean shouldDropLoot(net.minecraft.server.level.ServerLevel serverLevel) {
        return super.shouldDropLoot(serverLevel) && getPossessedByLicowitchId() == -1;
    }
