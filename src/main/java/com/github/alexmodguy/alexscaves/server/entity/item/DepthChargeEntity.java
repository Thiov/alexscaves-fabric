...
public class DepthChargeEntity extends ThrowableItemProjectile {
    ...
    public DepthChargeEntity(Level level, LivingEntity thrower) {
        super(ACEntityRegistry.DEPTH_CHARGE.get(), thrower, level, net.minecraft.world.item.ItemStack.EMPTY);
    }

    public DepthChargeEntity(Level level, double x, double y, double z) {
        super(ACEntityRegistry.DEPTH_CHARGE.get(), x, y, z, level, net.minecraft.world.item.ItemStack.EMPTY);
    }
    ...
    protected void onHitEntity(EntityHitResult hitResult) {
        ...
        hitResult.getEntity().hurtOrSimulate(damageSources().thrown(this, this.getOwner()), 2.0F + random.nextInt(2));
    }
