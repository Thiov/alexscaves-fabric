...
public class SmoothLimestoneBlock extends Block {
    ...
    public net.minecraft.world.InteractionResult useItemOn(ItemStack itemstack, BlockState state, Level level, BlockPos blockPos, Player player, InteractionHand interactionHand, BlockHitResult blockHitResult) {
