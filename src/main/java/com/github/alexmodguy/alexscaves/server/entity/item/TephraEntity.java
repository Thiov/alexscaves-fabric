...
public class TephraEntity extends Projectile {
    ...
    private static final EntityDataAccessor<Optional<UUID>> ARC_TOWARDS_ENTITY_UUID = SynchedEntityData.defineId(TephraEntity.class, com.github.alexmodguy.alexscaves.server.entity.ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    protected void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput tag) {
        this.setScale(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(tag, "Scale"));
        this.setMaxScale(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(tag, "MaxScale"));
