...
public class ACEffectRegistry {
    ...
    private static Holder<MobEffect> resolveDeferredEffectHolder(DeferredHolder<MobEffect, ? extends MobEffect> mobEffect) {
        Holder.Reference<MobEffect> registeredHolder = com.github.alexmodguy.alexscaves.server.misc.RegistryCompat.getHolder(BuiltInRegistries.MOB_EFFECT, mobEffect.getId().identifier()).orElse(null);
        if (registeredHolder != null) {
            return registeredHolder;
        }
    ...
    private static Holder<Potion> resolveDeferredPotionHolder(DeferredHolder<Potion, ? extends Potion> potion) {
        Holder.Reference<Potion> registeredHolder = com.github.alexmodguy.alexscaves.server.misc.RegistryCompat.getHolder(BuiltInRegistries.POTION, potion.getId().identifier()).orElse(null);
        if (registeredHolder != null) {
            return registeredHolder;
        }
