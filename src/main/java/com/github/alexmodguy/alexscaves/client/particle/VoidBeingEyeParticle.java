...
public class VoidBeingEyeParticle extends net.minecraft.client.particle.TextureSheetParticle implements RenderInWorldParticle {

    private static final Identifier[] TEXTURES = new Identifier[]{
            Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/particle/void_eye_0.png"),
            Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/particle/void_eye_1.png"),
            Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/particle/void_eye_2.png")
    };
