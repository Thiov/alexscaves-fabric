...
public class VoidBeingTendrilParticle extends net.minecraft.client.particle.TextureSheetParticle implements RenderInWorldParticle {
    ...
    private Quaternionf calcCameraAngle(Camera camera, float sampleScale) {
        ...
        return new Quaternionf(camera.rotation()).rotateX(followCameraAmount * -0.017453292F * camera.xRot()).rotateY(followCameraAmount * 0.017453292F * camera.yRot());
    }
