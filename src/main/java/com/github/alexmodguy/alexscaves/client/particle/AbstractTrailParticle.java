...
public abstract class AbstractTrailParticle extends net.minecraft.client.particle.TextureSheetParticle implements RenderInWorldParticle {
    ...
    public float getTrailRot(Camera camera) {
        return -0.017453292F * camera.xRot();
    }
