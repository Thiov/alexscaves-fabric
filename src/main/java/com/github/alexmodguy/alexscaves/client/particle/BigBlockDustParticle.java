...
public class BigBlockDustParticle extends TextureSheetParticle {
    ...
    public static class Factory implements ParticleProvider<BlockParticleOption> {
        ...
        public Particle createParticle(BlockParticleOption typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, net.minecraft.util.RandomSource randomSourceCompat) {
