...
public class ProtonParticle extends MagneticOrbitParticle {
    ...
    private static final Identifier CENTER_TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/particle/proton_core.png");
    private static final Identifier PROTON_TRAIL_TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/particle/teletor_trail.png");
